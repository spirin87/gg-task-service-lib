package com.gost_group.gis_tek.task.modeshape;
...
public class ModeShapeService {
    ...
    public void test() {
        ...
        try {
            URL url = ModeShapeService.class.getClassLoader().getResource("my-repository-config.json");
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                System.out.println(node.isNode());
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
